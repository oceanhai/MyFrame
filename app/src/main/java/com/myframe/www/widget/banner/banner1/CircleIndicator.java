...
public class CircleIndicator extends LinearLayout implements OnPageChangeListener {
    ...
    private int mAnimatorResId = R.anim.library_circle_indicator_scale;
    private int mAnimatorReverseResId = -1;
    private int mIndicatorBackground = R.drawable.widget_banner1_circle_indicator_white_radius;
    private int mIndicatorUnselectedBackground = R.drawable.widget_banner1_circle_indicator_white_radius;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mAnimatorResId = typedArray.getResourceId(R.styleable.CircleIndicator_ci_animator,
                    R.anim.library_circle_indicator_scale);
            ...
            mIndicatorBackground = typedArray.getResourceId(R.styleable.CircleIndicator_ci_drawable,
                    R.drawable.widget_banner1_circle_indicator_white_radius);
