package com.myframe.www.widget.refresh1;
...
public class XListView extends ListView implements OnScrollListener {
	...
	private boolean itemAnimEnable = false;
	...
	public XListView(final Context context, AttributeSet attrs, int defStyle) {
	...
	private void initWithContext(final Context context) {
		...
		// mHeaderTimeView.setText(CommonTools.getStringDate());
			...
			public void handleMessage(Message msg) {
				...
				switch (result) {
					case DOWNREFRESH: {
						...
						if (null != view) {
							// ���ض��� ������Ի����ض��� alpha doorrotate sacle
							animation = AnimationUtils.loadAnimation(context,
									R.anim.xlistview_item_anim);
	...
	public void setItemAnimEnable(boolean b) {
		// TODO Auto-generated method stub
		itemAnimEnable = b;
	}
}
