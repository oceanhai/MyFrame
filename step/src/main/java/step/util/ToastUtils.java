...
public class ToastUtils {
    ...
    private static void toastString(String str, int showTime) {
        MyToast.getToast(StepManager.getmContext(), str, showTime).show();
    }
    ...
    private static void toastResId(int resId, int showTime) {
        MyToast.getToast(StepManager.getmContext(), StepManager.getmContext().getString(resId), showTime).show();
    }
