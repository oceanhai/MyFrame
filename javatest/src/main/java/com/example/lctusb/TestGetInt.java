...
//        System.out.println("凑整:Math.ceil(-2.9)=" + (int)Math.ceil(-m));
        ...
        double a4 = 1.510;
        double a5 = 1.499;
        BigDecimal result1 = new BigDecimal(a1).setScale(0, BigDecimal.ROUND_HALF_UP);
        BigDecimal result2 = new BigDecimal(a2).setScale(0, BigDecimal.ROUND_HALF_UP);
        BigDecimal result3 = new BigDecimal(a3).setScale(0, BigDecimal.ROUND_HALF_UP);
        BigDecimal result4 = new BigDecimal(a4).setScale(0, BigDecimal.ROUND_HALF_UP);
        BigDecimal result5 = new BigDecimal(a5).setScale(0, BigDecimal.ROUND_HALF_UP);
        int z1 = result1.intValue();
        int z2 = result2.intValue();
        int z3 = result3.intValue();
        int z4 = result4.intValue();
        int z5 = result5.intValue();
